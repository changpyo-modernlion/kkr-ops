...
{{- printf "%s-%s" .Chart.Name "database" | trunc 63 | quote }}
{{- end }}

{{/*
아마존 정보 저장 시크릿
*/}}
{{- define "strapi.secretNameForAWS" -}}
{{- printf "%s-%s" .Chart.Name "aws" | trunc 63 | quote }}
{{- end }}

{{/*
참고용 컨피그맵
*/}}
{{- define "strapi.configMapNameForCommon" -}}
{{- printf "%s-%s" .Chart.Name "common" | trunc 63 | quote }}
{{- end }}